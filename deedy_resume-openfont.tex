...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Bhavinn}{Ingle}
% \urlstyle{same}\url{http://inglebhavin98.github.io} | Github:// \href{https://github.com/inglebhavin98}{\custombold{inglebhavin98}}
...
\textbullet{} HTML, CSS \textbullet{} Python \textbullet{} \LaTeX\\\
% \location{Familiar:}
MobX \textbullet{} MUI \textbullet{} Embedded C \textbullet{} IoT
\sectionsep

\section{Publications}

\href{https://ieeexplore.ieee.org/document/8929398}{Implementation of Virtual OPC on Cloud}\textbullet{} 
{\footnotesize \textit{\textbf{\custombold{TENCON 2019} IEEE Region 10 Flagship International Conference, Kochi, IN}}} \ExternalLink\\
\vspace{1.5mm}
\href{https://ieeexplore.ieee.org/abstract/document/9002485}{Aquaculture Monitoring and Feedback System}\textbullet{}
{\footnotesize \textit{\textbf{IEEE International Symposium on Smart Electronic Systems (\custombold{iSES}), NIT-R, IN}}} \ExternalLink\\
\vspace{1.5mm}
...
% 1. TDL
\vspace{1mm}
\runsubsection{\href{https://tatadigital.com/}{Tata Neu \ExternalLink}}
...
\sectionsep
% 2. ZES
\runsubsection{\href{https://in.linkedin.com/company/zargun-es}{Zargun ES \ExternalLink}}
% \descript{| Product Development \& Engineering}
\descript{| Co-founder \& Product Development Lead}
\vspace{0.5mm}
\location{Oct 2019 – Oct 2022 | Mumbai, IN}
\vspace{1.5mm}
\small {
%%%%%%%%
...
\descript{Aquacare | TI India \& IIM-B (IICDC) | Funded - US\$6700} 
\location{DEC 2018 - JULY 2019 | Bangalore, IN | Mentor - \textbf{\href{https://extc.spit.ac.in/faculty/prof-y-s-rao/}{Prof YS Rao, SPIT}} \ExternalLink}
% \begin{tightemize}
% \end{tightemize}
\small {
...
\descript{Mitsubishi Electric Cup'19 | Funded - US\$2700}
\location{NOV'18 - FEB'19 | Pune \& Delhi, IN | Mentor - \textbf{\href{https://in.linkedin.com/in/santosh-kulkarni-72a881134}{Mr Santosh K of MEI}} \ExternalLink}
\small {
...
\descript{AUTOMATA (OBD Scanner) | ARM Design Challenge}
...
\descript{CyberSec Lab - SPIT | Undergraduate Research Project}
\location{JUN'19 - MAY'20 | SPIT, Mumbai, IN | Mentor - \textbf{\href{https://extc.spit.ac.in/faculty/prof-dayanand-ambawade/}{Prof Ambawade, SPIT}} \ExternalLink}
\small {
